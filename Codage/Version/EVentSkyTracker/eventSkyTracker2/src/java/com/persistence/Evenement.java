...
public class Evenement {
    ...
    public static void cocherNew() throws Exception {
      ...
      String query = "UPDATE skytracker2.evenement SET `nouveau` = false WHERE nouveau = true";        
    ...
    private Evenement(int id, String idOfficiel, String telescope, String chemin,
            String type, Timestamp date, boolean nouveau) throws Exception {
        this.id = id;
