/*
 * Fichier : Galaxie.java
 * Description : Classe interface de la table galaxie
 * Cette table stocke les infos sur les galaxies utilisées par le logiciel
 */
...
public class Galaxie {
     ...
     * @return String la galaxie en position i
     * @throws java.lang.Exception
     */
