<%-- 
    Document   : pseudoPerdu
    Description : Page pour retrouver sont pseudo
--%>
...
<div class="page" data-role="page" id="infoPopUpPseudoPerdu" >
    ...
    <div role="main" class="ui-content"><br/><br/>
        <form id="formPseudoPerdu" method="post" onsubmit="infoPopUpPseudoPerdu();" action="eventSkyTracker.jsp">
            ...
            <input name="action" id="pseudoPerduAction" type="hidden" value="pseudoPerdu_req"/>
