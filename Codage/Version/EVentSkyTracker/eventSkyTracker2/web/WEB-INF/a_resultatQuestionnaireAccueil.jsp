        ...
        <div role="main" class="ui-content">
            ...
            <div data-role="content">
              ...
              -->  
                ...
                <a id="btnQualSn" class="ui-btn" data-role="button" onclick="window.location.href='eventSkyTracker.jsp?action=a_resultatQuestionnaireSn'" > Supernovae </a>
               <br> <br/> 
               <br> <br/>
               <br> <br/>
               <a id="btnQualEST" class="ui-btn" data-role="button" onclick="window.location.href='eventSkyTracker.jsp?action=a_resultatQuestionnaire'">Ondes Gravitationnel </a>
