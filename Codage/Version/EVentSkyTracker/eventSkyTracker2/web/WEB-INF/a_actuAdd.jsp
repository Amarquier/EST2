<%-- 
    Document    : Ajout d'une actualité en mode administrateur
    Description : recoit par Ajax l'actu à ajouter
--%>
...
<%    
    ...
    Actu actu = Actu.create(con, sDate, sTitre, sContenu);
%>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div class="page" data-role="page" id="homePage">
    ...
    <div role="main" class="ui-content">
        <br/><br/>
        <br/><br/><br/><br/>
        <div class="centrer"><h1>L'actualité a bien été ajouté.</h1></div>
        <br/><br/>
