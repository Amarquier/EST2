...
grant  select on skytracker2.actu to skytracker2@localhost identified by 'skytrackerNovae31';
grant  select on skytracker2.galaxie to skytracker2@localhost identified by 'skytrackerNovae31';
grant  select on skytracker2.imageSN to skytracker2@localhostt identified by 'skytrackerNovae31';
grant  select on skytracker2.skyobjects to skytracker2@localhost identified by 'skytrackerNovae31';  # inutilisée
grant  select,update on skytracker2.evenement to skytracker2@localhost identified by 'skytrackerNovae31';
grant  select on skytracker2.candidateEST to skytracker2@localhost identified by 'skytrackerNovae31';
grant  select on skytracker2.imageEST to skytracker2@localhost identified by 'skytrackerNovae31';
