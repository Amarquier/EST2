...
<%
    ...
    if (action == null) {
        ...
        if (action.equals("qcm_req")) {
            ...
            } else if (action.equals("a_resultatQuestionnaireAccueil")) {
                request.getRequestDispatcher("WEB-INF/a_resultatQuestionnaireAccueil.jsp").forward(request, response);
            ...
            } else if (action.equals("a_resultatQuestionnaireSn")) {
                request.getRequestDispatcher("WEB-INF/a_resultatQuestionnaireSn.jsp").forward(request, response);
