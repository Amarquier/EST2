/*
 * Nom : a_candidates.js 
 * Script en javaScript pour la section en mode user
 * de l'application smartphone
 * Utilisé par qualifier.jsp uniquement
 */
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (i = 0; i < tabInfos.length; i++) {
                ...
                var leChemin = (info.charAt(0) === 'F') ? "/jpeg/images_EST/Tarot_Calern/" : "/jpeg/images_EST/Tarot_Chili/";
