<%-- 
    Document    : Modification d'une actualité en mode administrateur
    Description : recoit par Ajax l'actu à modifier
--%>
...
<div class="page" data-role="page" id="homePage">
    ...
    <div role="main" class="ui-content">
        ...
        <strong>Titre:</strong>
        <form id="formModActu" method="post" action="eventSkyTracker.jsp?action=a_actuMod_req">
         ...
         <strong>Contenu:</strong> 
            ...
            <a href="eventSkyTracker.jsp?action=a_actu" id="btnEnvoyer" data-position-to="window" 
                class="ui-btn ui-corner-all ui-shadow">
                Annuler
            </a>
        </form>
