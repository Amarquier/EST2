            ...
            <div data-role="content">
              ...
              -->  
                ...
                <a id="btnQualSn" class="ui-btn bouton_a" data-role="button" onclick="window.location.href='eventSkyTracker.jsp?action=a_resultatQuestionnaireSn'" > <br><br/>Supernovae </a>
                     ...
                     <br> <br/>
                     <br> <br/>
                     <a id="btnQualEST" class="ui-btn bouton_a" data-role="button" onclick="window.location.href='eventSkyTracker.jsp?action=a_resultatQuestionnaire'"><br><br/>Killonovae </a>
