...
<div class="page" data-role="page" id="discoPage" data-theme="b" style="background-color:#aacaba;">
    ...
    <div class="header" data-role="header" data-id="main-header" data-tap-toggle="false" 
        ...
        <script type="text/javascript">  
            <%
                ...
                */
                ...
                out.print("cheminRef = '/jpeg/refgal/';");
                out.println("'/jpeg/Tarot_Chili/" + img.getDate() + "/';");
        ...
        <div class="mesImages" align="center">
            ...
            <a href='#popupZoomRight' id='clicZoomRight' data-rel='popup'>
                <img id='imgref' alt='.... aucune référence ....' src='/jpeg/refgal/<%=img1.getGalaxieRef()%>.jpg'/>
            </a>
        </div>
