/*
 * Fichier : Actu.java
 * Description : Classe interface de la table actu
 * Cette table stocke les actualitées de la page Actu
 */
...
public class Actu {
    ...
    private static Actu creerParRequete(ResultSet result) throws Exception {
        int lId = result.getInt("id");
        String lDate = result.getString("Date");
        String lTitre = result.getString("Titre");
        String lContenu = result.getString("Contenu");
        return new Actu(lId, lDate, lTitre, lContenu);
    }
     ...
     * @return String l'actu en position i
     * @throws java.lang.Exception
     */
