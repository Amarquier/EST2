 ...
 * Cette table gère les images affichables par le logiciel
 */
...
public class ImageSN {
    ...
    private String galaxieRef;    // modification 6 mars 2017
     ...
     */
    public static ImageSN getById(Connection con, int idImage) throws Exception {
        String queryString = "select * from imageSN where `id`=" + idImage;
        ...
        if (lResult.next()) {
            ...
            ImageSN image = new ImageSN(idImage, lDate, lGalaxieNom, lChemin, 
    ...
    public static ImageSN getByChemin(Connection con, String telescope, String galaxie, String date) throws Exception{
        String queryString = "select `id` from imageSN "
        ...
        ResultSet lResult = lStat.executeQuery(queryString);
        if (lResult.next()) {
            ImageSN image = ImageSN.getById(con, lResult.getInt("id"));
            return image;
        }
        else{
            return null;
    ...
    public static ImageSN getByCandidat(Connection con, String chemin, String nomImage) throws Exception{
    ...
    public static boolean existByDate(Connection con, String date) throws SQLException{
        String queryString = "select `id` from imageSN where `Date`='"+date+"'";      
        Statement lStat = con.createStatement(
                            ResultSet.TYPE_SCROLL_INSENSITIVE, 
                            ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
     ...
     * @throws java.lang.Exception
     */
    public static ImageSN find(Connection con, String _dateobs, int i) throws Exception {
        String queryString = "select `id` from imageSN "
        ...
        if ((i > 0) && lResult.absolute(i)) {
            ...
            return ImageSN.getById(con, idImage);
        }
        else 
            return null;
    }
    ...
    public static ArrayList<String> getDerniersJours(Connection con) throws Exception {
        ...
        String queryString = "select distinct `Date` from imageSN "
     ...
     * @throws java.lang.Exception
     */
    public static ArrayList<ImageSN> getImagesDuJour(Connection con, String _dateobs) throws Exception {
        ArrayList<ImageSN> images = new ArrayList<ImageSN>();
        // 
        String queryString = "select * from imageSN "
                      + " where `Date`='" + _dateobs + "' order by GalaxieNom";
        Statement lStat = con.createStatement(
                            ResultSet.TYPE_SCROLL_INSENSITIVE, 
                            ResultSet.CONCUR_READ_ONLY);
        ...
        while (lResult.next()) { 
            ...
            double    lRa          = lResult.getDouble("ra");
            double    lDec         = lResult.getDouble("dec");
            ImageSN image = new ImageSN(lImageId, lDate, lGalaxieNom, lChemin, lDateobs,
    ...
    public static ArrayList<String> getDernieresImages(Connection con, String _nomGalaxie) throws Exception {
        ...
        String queryString = "select Date, chemin from imageSN "
    ...
    public static String dernierJour(Connection con)  throws Exception {
        ...
        String queryString = "select `Date` from imageSN "
    ...
    public static int nbImageDuJour(Connection con, String _jour) throws Exception {
        // format du _jour : '20140108'
        String queryString = "select count(*) as count from imageSN "
                                             + " where `Date`='" + _jour + "'";
        Statement lStat = con.createStatement(
                            ResultSet.TYPE_SCROLL_INSENSITIVE, 
                            ResultSet.CONCUR_READ_ONLY);
     ...
     */
    private ImageSN (int id, String date, String galaxieNom, String chemin, 
