<%-- 
    Document   : login.jsp
    Description : Page pour ce connecter
--%>
...
<div class="page" data-role="page" id="loginPage">
    <div class="header" style="background-color: #015550" data-role="header" 
        data-id="main-header" data-tap-toggle="false" 
    ...
    <div role="main" class="ui-content">
        ...
        <br/>
        <form id="formLogin" method="post" action="eventSkyTracker.jsp">
            ...
            <input name="action" id="accountAction" type="hidden" value="login_req"/>
            <button type="submit" id="submitOK" name="submitOK" data-theme="a">OK</button>
        </form>
        <br/><br/>
        <div>
        <a href="eventSkyTracker.jsp?action=motDePassePerdu" data-theme="a" 
                class="ui-btn ui-shadow ui-corner-all ui-btn-a">
            J'ai oublié mon mot de passe !
        </a><br/>
        <a href="eventSkyTracker.jsp?action=pseudoPerdu" data-theme="a" 
                class="ui-btn ui-shadow ui-corner-all ui-btn-a">
            J'ai oublié mon pseudo !
        </a>
        </div><br/>
        <div>
            <a href="tuto.jsp" data-theme="a"
               class="ui-btn ui-shadow ui-corner-all ui-btn-a">
