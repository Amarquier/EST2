...
<div class="page" data-role="page" id="changerProfilPage">
    ...
    <div role="main" class="ui-content">
        ...
        <form id="formMajProfil" method="post"
                                    action="eventSkyTracker.jsp?action=profilMod_req">
            ...
            <div class="ui-grid-a">
                <div class="ui-block-a">
                    <a href="eventSkyTracker.jsp?action=infoUser" id="cmdpAnnuler"  
                       data-role="button">Annuler</a>
                </div>
                <div class="ui-block-b">
                    <label for="cmdpAction" class="ui-hidden-accessible"></label>
                    <input name="action" id="cmdpAction" type="hidden" value="profilMod_req">
