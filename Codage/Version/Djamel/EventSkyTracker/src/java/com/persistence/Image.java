...
public class Image {
     ...
     * @throws java.lang.Exception
     */
    public static Image getByChemin(Connection con, String chemin) throws Exception {
        String queryString = "select `id` from image" + " where `chemin`='" + chemin + "'";
        Statement lStat = con.createStatement(
                ResultSet.TYPE_SCROLL_INSENSITIVE,
                ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
     ...
     * @throws java.lang.Exception
     */
    public static Image getOneByCandidate(Connection con, int canId, int i) throws Exception {
     ...
     * @throws java.lang.Exception
     */
    public static ArrayList<Image> getByCandidate(Connection con, int canId) throws Exception {
    ...
    private static Image creerParRequete(ResultSet result) throws Exception {
        ...
        return new Image(lId, lCanId, lChemin, lDateobs,
     ...
     */
    private Image(int id, int canId, String chemin, Timestamp dateobs,
